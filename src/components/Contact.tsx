            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  onChange={handleChange}
                  className="w-14 sm:w-20 bg-gray-800/50 border border-gray-600 rounded-xl px-1 sm:px-4 py-3 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-all duration-300 text-center text-sm sm:text-base"
                  required
                  disabled={isSubmitting}
                />
                <input
                  ...
                  onChange={handleChange}
                  className="flex-1 min-w-0 bg-gray-800/50 border border-gray-600 rounded-xl px-3 sm:px-4 py-3 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-all duration-300 text-sm sm:text-base"
                  required
                  disabled={isSubmitting}
                />
              </div>
